  ...
  return (
    <div className="min-h-screen bg-gray-950 p-12 text-white">
      <header className="mb-12">
        ...
        <p className="text-gray-500 mt-2 font-mono text-sm uppercase tracking-widest">Compare P/E, PEG, and other key ratios</p>
      </header>
      ...
      <main className="flex flex-col items-center justify-center min-h-[50vh] border-2 border-dashed border-gray-800 rounded-3xl bg-gray-900/20">
        <div className="text-center space-y-4">
          ...
          <p className="text-gray-500 max-w-xs mx-auto">Comparative ratio analysis engine is spinning up.</p>
        </div>
      </main>
    </div>
  );
